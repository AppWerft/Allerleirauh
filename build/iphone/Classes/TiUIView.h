...
/**
 Base class for all Frontlineshop views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Frontlineshop view hierarchy (such as wrapped iOS UIViews) was touched.
