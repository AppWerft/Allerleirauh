...
// in simulator we redefine to format for Frontlineshop Developer console
...
{\
	NSString * exceptionName = [@"org.frontlineshop." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.frontlineshop";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFrontlineshopNativeItemNone = -1, 
	UIFrontlineshopNativeItemSpinner = -2,
	UIFrontlineshopNativeItemProgressBar = -3,
	
	UIFrontlineshopNativeItemSlider = -4,
	UIFrontlineshopNativeItemSwitch = -5,
	UIFrontlineshopNativeItemMultiButton = -6,
	UIFrontlineshopNativeItemSegmented = -7,
	
	UIFrontlineshopNativeItemTextView = -8,
	UIFrontlineshopNativeItemTextField = -9,
	UIFrontlineshopNativeItemSearchBar = -10,
	
	UIFrontlineshopNativeItemPicker = -11,
	UIFrontlineshopNativeItemDatePicker = -12,
	
	UIFrontlineshopNativeItemInfoLight = -13,
	UIFrontlineshopNativeItemInfoDark = -14,
	
	UIFrontlineshopNativeItemDisclosure = -15,
	
	UIFrontlineshopNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Frontlineshop instances of
