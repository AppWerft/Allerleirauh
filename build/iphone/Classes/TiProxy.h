...
//Rare exceptions to indicate a bug in the _frontlineshop code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Frontlineshop proxies.
 */
