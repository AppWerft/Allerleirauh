...
@interface FrontlineshopObject : KrollCoverageObject {
#else
@interface FrontlineshopObject : KrollObject {
#endif
@private
...
extern NSString * Frontlineshop$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FrontlineshopObject *_frontlineshop;
    KrollObject* console;
	BOOL shutdown;
