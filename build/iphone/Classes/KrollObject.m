...
//@interface FrontlineshopObject : NSObject
//@end

@interface FrontlineshopObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FrontlineshopObject class]])
		{
			for (NSString *key in [[(FrontlineshopObject*)o modules] allKeys])
			{
